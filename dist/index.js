...
exports.SafePal = exports.NoSafePalError = void 0;
const types_1 = require("@web3-react/types");
class NoSafePalError extends Error {
    constructor() {
...
exports.NoSafePalError = NoSafePalError;
function parseChainId(chainId) {
    return Number.parseInt(chainId, 16);
}
class SafePal extends types_1.Connector {
    ...
    isomorphicInitialize() {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.eagerConnection)
                return;
            return (this.eagerConnection = Promise.resolve().then(() => __importStar(require('@akkafinance/safepal-detect-provider'))).then((m) => __awaiter(this, void 0, void 0, function* () {
                var _a, _b;
                const provider = yield m.default(this.options);
                if (provider) {
                    this.provider = provider;
                    if ((_a = this.provider.providers) === null || _a === void 0 ? void 0 : _a.length) {
                        this.provider = (_b = this.provider.providers.find((p) => p.isSafePal)) !== null && _b !== void 0 ? _b : this.provider.providers[0];
                    }
